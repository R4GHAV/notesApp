...
addBtn.addEventListener('click', function () {
  ...
  if (text.value !='') {
    ...
    yourNotes.innerHTML+=`<div class="an allNotes${count}"><h3><b>NOTE</b></h3><textarea name="name" class="smallText${count}" rows="8" cols="8" readonly></textarea><button type="button"  onClick='delfun(${count})' class= "del${count}"name="button">Delete note</button></div>`
